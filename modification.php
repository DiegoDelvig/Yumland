        ...
        <h1>MODIFICATION DE COMPTE</h1>
                <form action="" method="post" target="_top" id="formulaire" name="connexion">
                    <div class="rect_bleu">
                        ...
                        <input type="text" name="nname" id="idname" class="login_case_name" value="<?php echo htmlspecialchars($client["name"], ENT_QUOTES, 'UTF-8'); ?>" maxlength="50">
                        ...
                        <input type="text" name="nfname" id="idfname" class="login_case_fname" value="<?php echo htmlspecialchars($client["fname"], ENT_QUOTES, 'UTF-8'); ?>" maxlength="50">
                        ...
                        <input type="text" name="nadr" id="idadr" class="login_case_adr" value="<?php echo htmlspecialchars($client["adr"], ENT_QUOTES, 'UTF-8'); ?>">
                        <span class="erreur_champ" id="erreur_idadr"></span>

                        <label for="idtel" class="input_label">Téléphone :</label>
                        <input type="tel" name="ntel" id="idtel" class="login_case_tel" value="<?php echo htmlspecialchars($client["tel"], ENT_QUOTES, 'UTF-8'); ?>" maxlength="14">
                        ...
                        <textarea name="ninfocomp" id="idinfocomp" class="login_case_infocomp"><?php echo htmlspecialchars($client["infocomp"], ENT_QUOTES, 'UTF-8'); ?></textarea>
